...
class MaterialAreaChart extends StatefulWidget {
  ...
  factory MaterialAreaChart.fromPlotlyJson({
    ...
    final AreaChartStyle finalStyle =
        styleOverrides != null
  ...
  ///
  /// This constructor allows you to directly use a Map<String, dynamic>
  ...
  static AreaChartStyle _mergeStyles(
    ...
    return AreaChartStyle(
      ...
      animationCurve:
          overrides.animationCurve != Curves.easeInOut
              ? overrides.animationCurve
              : baseStyle.animationCurve,
      padding:
          overrides.padding != const EdgeInsets.all(24)
              ? overrides.padding
              : baseStyle.padding,
      horizontalGridLines:
          overrides.horizontalGridLines != 5
              ? overrides.horizontalGridLines
              : baseStyle.horizontalGridLines,
      forceYAxisFromZero:
          overrides.forceYAxisFromZero != true
